...
//
//   [1] Campfire      — gravity, drag, turbulence (curl noise), alpha smoke
...
class MainApp final : public fra::AbstractApplication
{
  public:
    ...
    void StartUp() override
    {
        ...
        // Ground plane
        mGroundMesh = FreyaExamples::CreateGroundPlane(*mMeshPool, 12.f,
                                                        glm::vec3(0.15f));
        ...
        mFireFlames.gravity           = { 0.f, 0.3f, 0.f }; // slight upward assist
        ...
        // 4×4 atlas: each row has 4 frames of a spinning sparkle
        // (white texture = all frames look the same, but uvRect animates)
        ...
        mBurstEmitter.spawnRate    = 0.f; // only bursts, no continuous spawn
    ...
    void Update() override
    {
        ...
        // Derive camera basis from FlyCam for ribbon orientation.
        ...
        // [2] Magic Portal — slowly orbit particles
        mPortal.origin = { 0.f, 1.2f, 0.f };
